...
public class Coin : MonoBehaviour {
	...
	public void OnCoinClicked () {
        ...
        //GameObject.Instantiate(coinPoofPrefab, position,Quaternion.identity);
        GameObject tempInstance = GameObject.Instantiate(coinPoofPrefab, position,Quaternion.identity);
        // Use Destroy() to delete the coin after for example 0.5 seconds
        //GameObject.Destroy(tempInstance, 0.5f);
        //GameObject.Destroy(this, 0.5f);
        GameObject.Destroy(gameObject, 0.5f);
        //GameObject.Destroy(coinPoofPrefab, 0.5f);
    }
}
