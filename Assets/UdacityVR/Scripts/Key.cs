...
public class Key : MonoBehaviour {
	...
	public void OnKeyClicked () {
        ...
        GameObject tempKey = GameObject.Instantiate(keyPoofPrefab, transform.position, Quaternion.identity);
        // Use Destroy() to delete the key after for example 0.5 seconds
        // GameObject.Destroy(tempKey, 0.5f);
        //GameObject.Destroy(GameObject.Find("Key"), 0.5f);
